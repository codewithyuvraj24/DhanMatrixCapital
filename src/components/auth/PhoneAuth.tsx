...
export default function PhoneAuth() {
    ...
    const handleSendOTP = async (e: React.FormEvent) => {
        ...
        try {
            ...
            if (err.code === 'auth/too-many-requests') customError = 'Too many requests. Please wait.'
            else if (err.message === 'Please enter a valid 10-digit mobile number') customError = err.message
    ...
    const handleVerifyOTP = async (e: React.FormEvent) => {
        ...
        try {
            ...
            // Check if user exists and check onboarding status
                    ...
                    >
                        <div className="space-y-3">
                            ...
                            <div className="relative group">
                                ...
                                <div className="absolute inset-y-0 left-12 flex items-center pr-3 border-r border-slate-200 dark:border-white/10 h-6 top-1/2 -translate-y-1/2">
                                    <span className="text-slate-900 dark:text-white font-black text-sm tracking-tighter">+91</span>
                                </div>
                                <input
                                    type="tel"
                                    value={phoneNumber}
                    ...
                    >
                        <div className="space-y-3">
                            <div className="flex justify-between items-center ml-2">
                                <label className="block text-xs font-black text-slate-400 uppercase tracking-widest">Verify OTP</label>
                                <button
                                    type="button"
