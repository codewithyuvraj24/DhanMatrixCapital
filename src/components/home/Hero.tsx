    ...
    return (
        <section className="relative min-h-screen flex items-center pt-24 pb-12 sm:pt-32 sm:pb-20 overflow-hidden bg-white dark:bg-slate-950 transition-colors duration-500">
            ...
            <div className="absolute inset-0 pointer-events-none overflow-hidden">
                <div className="absolute top-[-10%] right-[-5%] w-[600px] h-[600px] bg-blue-100 dark:bg-blue-900/20 rounded-full blur-[100px] opacity-60 animate-blob will-change-transform"></div>
                <div className="absolute bottom-[-10%] left-[-10%] w-[500px] h-[500px] bg-purple-100 dark:bg-purple-900/20 rounded-full blur-[100px] opacity-60 animate-blob animation-delay-2000 will-change-transform"></div>
                <div className="absolute top-[20%] left-[20%] w-[400px] h-[400px] bg-emerald-50 dark:bg-emerald-900/10 rounded-full blur-[80px] opacity-40 animate-blob animation-delay-4000 will-change-transform"></div>
            </div>
