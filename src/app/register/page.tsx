        ...
        <div className="bg-white/60 dark:bg-black/40 backdrop-blur-3xl border border-white/20 dark:border-white/10 rounded-3xl sm:rounded-[2.5rem] shadow-2xl overflow-hidden">
          <div className="p-6 sm:p-10 text-center border-b border-slate-100/50 dark:border-white/5 bg-slate-50/30 dark:bg-white/5">
            <Link href="/" className="inline-block group">
              <div className="inline-flex items-center justify-center w-16 h-16 sm:w-20 sm:h-20 rounded-2xl sm:rounded-3xl bg-emerald-600/10 dark:bg-emerald-500/10 border border-emerald-500/20 mb-4 sm:mb-6 group-hover:scale-105 transition-transform duration-500">
                <UserPlus className="text-emerald-600 dark:text-emerald-400 w-8 h-8 sm:w-10 sm:h-10" />
              </div>
              <h2 className="text-2xl sm:text-3xl font-black text-slate-900 dark:text-white tracking-tight group-hover:text-emerald-600 dark:group-hover:text-emerald-400 transition-colors">Join the Matrix</h2>
            </Link>
